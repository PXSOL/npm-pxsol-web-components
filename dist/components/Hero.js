...
const Hero = (props) => {
    ...
    return ((0, jsx_runtime_1.jsx)("section", { className: "hero", id: "hero", children: (0, jsx_runtime_1.jsxs)("div", { className: "container", children: [(0, jsx_runtime_1.jsxs)("div", { className: "hero-content", children: [(0, jsx_runtime_1.jsxs)("h1", { className: "h1 hero-title", children: ["## ", ((_a = props.titleHero) === null || _a === void 0 ? void 0 : _a.content) || "Título por defecto"] }), (0, jsx_runtime_1.jsx)("p", { className: "hero-text", children: ((_b = props.subtitleHero) === null || _b === void 0 ? void 0 : _b.content) || "Lorem ipsum dolor sit amet consectetur" }), (0, jsx_runtime_1.jsx)("p", { className: "hero-text", children: (_c = props.groupTextHero) === null || _c === void 0 ? void 0 : _c.content.map((item, index) => {
