  ...
  },
  {
    ...
    props: {
      ...
      Description1: {
        ...
        dataType: "textParagraph",
        content:
          "Discover breathtaking mountain landscapes and pristine hiking trails.",
        styleData: {
          titleColor: {
            styleContent: "#fff",
          },
      ...
      Description2: {
        ...
        dataType: "textParagraph",
        content:
          "Experience crystal clear waters and stunning coastal adventures.",
        styleData: {
          titleColor: {
            styleContent: "#fff",
          },
      ...
      Description3: {
        ...
        dataType: "textParagraph",
        content:
          "Explore vibrant cities with rich culture and modern attractions.",
        styleData: {
          titleColor: {
            styleContent: "#fff",
          },
